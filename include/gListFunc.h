#ifndef DE97CC40_56A5_4D12_B7D9_F86B5D1B11C3
#define DE97CC40_56A5_4D12_B7D9_F86B5D1B11C3

/* * * * * * * * * * * * * * * * * * * * *
 * GListFunc.h                           *
 * Generic list functions implement in C *
 * Author: LingDar77                     *
 * Version: 0.1.2                        *
 * Started: 4/18/2021                    *
 * Modified: 4/21/2021                   *
...
#define GENERATED_GLIST_FUNCTIONS(Type, NodeName, Name)                                                  \
    ...
    */                                                                                                   \
    ...
    /*                                                                                                   \
    Find a element in a list, return a pointer to pair or a NULL ptr                                     \
    you can provide a method to compare                                                                  \
    */                                                                                                   \
    ...
    static void *Name##_GENERATED_FREE_THREAD(void *p)                                                   \
    {                                                                                                    \
    ...
    {                                                                                                    \
        ...
        {                                                                                                \
            ...
            pthread_t ptn;                                                                               \
            pthread_create(&ptn, NULL, &Name##_GENERATED_FREE_THREAD, target->end);                      \
                                                                                                         \
            ...
            {                                                                                            \
                ...
                pthread_create(&pts[cnt], NULL, &Name##_GENERATED_FREE_THREAD, Reserve);                 \
                Reserve = buf1;                                                                          \
            }                                                                                            \
            free(target);                                                                                \
        }                                                                                                \
        ...
        {                                                                                                \
            ...
            {                                                                                            \
                ...
                {                                                                                        \
                    ...
                    pthread_create(&ptn[cnt * 2], NULL, &Name##_GENERATED_FREE_THREAD, Beg);             \
                    pthread_create(&ptn[cnt * 2 + 1], NULL, &Name##_GENERATED_FREE_THREAD, End);         \
                    Beg = buf1;                                                                          \
                    End = buf2;                                                                          \
                }                                                                                        \
                ...
                {                                                                                        \
                    ...
                    pthread_create(&ptn[cnt], NULL, &Name##_GENERATED_FREE_THREAD, Beg);                 \
                }                                                                                        \
                if (Reserve)                                                                             \
                {                                                                                        \
                    NodeName *buf1 = Reserve->next;                                                      \
    ...
    */                                                                                                   \
    ...
    } /*Delete the data in the list forever*/                                                            \
    static void Name##_Del(Name *target, Type val, int (*cmp)(Type, Type), void (*deletor)(Type *))      \
    {                                                                                                    \
        NodeName##_pair *pair = Name##_FindElement(target, val, cmp);                                    \
        if (pair == NULL)                                                                                \
        {                                                                                                \
        ...
        if (target->len > 1)                                                                             \
        {                                                                                                \
            NodeName *iterator = pair->Node;                                                             \
            NodeName *Next = iterator->next, *Pre = iterator->pre;                                       \
            Next->pre = Pre;                                                                             \
            Pre->next = Next;                                                                            \
            ++target->len;                                                                               \
            (*deletor)(&iterator->val);                                                                  \
            free(iterator);                                                                              \
        }                                                                                                \
        else if (target->len == 1)                                                                       \
        {                                                                                                \
            --target->len;                                                                               \
            (*deletor)(&target->beg->val);                                                               \
            free(target->beg);                                                                           \
            target->end = NULL;                                                                          \
            target->beg = NULL;                                                                          \
        }                                                                                                \
...
#endif /* DE97CC40_56A5_4D12_B7D9_F86B5D1B11C3 */
